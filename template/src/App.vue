    ...
    <div class="max-w-2xl mx-auto space-y-8">
      ...
      <div class="text-center space-y-3">
        ...
        <p class="text-gray-500">
          ...
          <code class="bg-gray-100 px-1.5 py-0.5 rounded text-sm font-mono text-indigo-700">src/App.vue</code>.
        </p>
      </div>
      ...
      <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
        ...
        <ul class="space-y-3 text-sm text-gray-600">
          <li class="flex gap-3">
            ...
            <span>Edit <code class="bg-gray-100 px-1 rounded font-mono">src/App.vue</code> to build your UI.</span>
          </li>
          <li class="flex gap-3">
            <span class="text-indigo-400 shrink-0">▸</span>
          ...
          <li class="flex gap-3">
            <span class="text-indigo-400 shrink-0">▸</span>
            <span>Run <code class="bg-gray-100 px-1 rounded font-mono">npm run build</code> to verify your production build, then deploy with <code class="bg-gray-100 px-1 rounded font-mono">vercel --prod</code>.</span>
          </li>
        </ul>
      </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'A modern Vue 3 project with Vite, Tailwind CSS v4, and Vercel API routes.',
    },
  ],
})
